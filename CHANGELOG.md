...
- **文档与配置同步**：pm2 配置（Linux/Windows）补充 DB2/MySQL 数据源密码与
  `MCP_DBTOOLS_SECRET_KEY`；README 版本号更正为 v1.0.3、补充 DB2/MySQL 数据源与架构图；
  AGENTS.md 数据源列表与工具数（19 个）更正；使用说明环境变量表补充数据源密码变量、
  架构图与驱动下载说明。
